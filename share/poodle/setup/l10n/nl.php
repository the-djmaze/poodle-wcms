...
'_ACTIVATED' => '%s is geactiveerd',
'Language' => 'Taal',
'Errors' => 'Errors',

# step 01
'I_Agree' => 'I ga Akkoord',

# step 02
'Verify' => 'Verifieer',
'Reload' => 'Vernieuwen',
'_access' => array('mislukt', 'gelukt'),
'_avail' => array('mist', 'beschikbaar'),
'Access Privileges' => 'Toegangsrechten',
'info_poodle_hosts' => 'Tijdelijke schrijftoegang nodig voor het opslaan van het configuratiebestand.',
'info_poodle_hosts/cache' => 'Schrijftoegang nodig voor meer snelheid en het wegschrijven van php error logs.',
...
'info_Server' => 'Uw server HTTP configuratie is:<br/>%s',
'info_OS' => 'Uw besturingssysteem is:<br/>%s',
'info_SEO' => 'Zoekmachine Optimisatie is een leuke feature welke Poodle WCMS in staat steld om vriendelijke uri\'s te maken. Het is waarschijnlijk beschikbaar voor uw HTTP Deamon (bijvoorbeeld in Apache als mod_rewrite).',

'Database Extensions' => 'Database Extensies',
...
'Preferred PHP Configuration' => 'Voorkeur PHP Configuratie',
...
'Administration directory' => 'Administratie map',
...
'Configuration status' => 'Configuratie status',
'Configuration complete!' => 'Configuratie voltooid!',
'Database' => 'Database Server',
'Layer' => 'Driver',
'Layer_info' => 'Which SQL Driver you want to use for connecting to the database.',
'Host' => 'Host',
...
'Passphrase_info' => 'Het wachtwoord van de opgegeven gebruiker.',
'Databasename' => 'Database naam',
'Databasename_info' => 'Naam van de database.',
...
'Save configuration file' => 'Configuratiebestand opslaan',
'failed' => 'mislukt',
'Download config.php file' => 'Download config.php bestand',
'Download_config_php' => 'Download en upload het configuratiebestand handmatig naar de %s map voordat U verder gaat.',

# step 04
'Failed to register sql stream filter' => 'Failed to register sql stream filter',
'Creating schema' => 'Schema aanmaken',
'Updating schema' => 'Schema updaten',
'Inserting data' => 'Data invoegen',
'Database configuration complete!' => 'Database configuratie voltooid!',
...
'Private details' => 'Privé details',
'Time zone info' => 'Tijdzone info',
