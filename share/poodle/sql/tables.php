...
class Table
{
	...
	public function upsert(array $insert_data, array $update_data, array $update_where = array())
	{
		return $this->db->upsert($this, $insert_data, $update_data, $update_where);
	}

	public function upsertPrepared(array $insert_data, array $update_data, array $update_where = array())
	{
		return $this->db->upsertPrepared($this, $insert_data, $update_data, $update_where);
	}

	protected function getFrom($where='')
	{
		return ' FROM ' . $this->name . $this->db->parseWhere($where);
	}
