...
class XRDS
{
	 ...
	 */
	public function services(?iterable $filters = null, int $filter_mode = self::MATCH_ANY) : array
	{
		// If no filters are specified, return the entire service
		// list, ordered by priority.
		if (!$filters || !is_iterable($filters)) {
		...
		throw new \Exception('An invalid filter mode is specified');
	}
}
